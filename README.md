...
- **Aba Trens agora é totalmente editável**: todos os campos (nome, tipo, nível, peso, passageiros, carga, comida, conforto, diversão, instalações, pontos) podem ser corrigidos direto na tabela — dá pra adicionar vagões novos ("+ Adicionar vagão") e remover os que não fazem sentido.
